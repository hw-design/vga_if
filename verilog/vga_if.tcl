# Run cdvga_if first to set the correct directory
...
# Create project
create_project -part xc7a100tcsg324-1 vga_if $outputdir -force
...
set_property PROGRAM.FILE {C:/Users/Jak/win_shared/projs/vga_if/verilog/synthesis/vga_if.runs/impl_1/vga_if.bit} [lindex [get_hw_devices] 0]
...
# "source vga_if.tcl" will run this script. -notrace will stop the command line from displaying the TCL code